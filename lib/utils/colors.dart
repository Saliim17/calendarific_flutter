...
class AppColors {
  ...
  static const Color textLightColor = Color(0xFF5C7CAF);
  static const Color mainColor =  Color.fromRGBO(154, 205, 50, 1); //Color.fromRGBO(62, 186, 57, 1); //rgba(62,186,57,255)  //Color(0xFF89dad0);
